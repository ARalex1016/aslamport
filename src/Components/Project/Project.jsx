...
const Project = () => {
  return (
    <section id="projects" className="w-full">
      ...
      {/* Project Container */}
      <div className="w-full flex flex-row flex-wrap justify-around items-center gap-2">
        {projectsOBj.projects.map((project, index) => {
          return (
            <div
              key={index}
              className="w-full max-w-80 bg-gray rounded-xl flex flex-col justify-center items-center gap-y-2 px-5 py-8"
            >
              {/* Thumbnail */}
              <img
