...
const AboutMe = ({ close, className, children }) => {
  return (
    <PopUpFullScreen onClose={close}>
      <section className="w-4/5 h-10/12 bg-gray rounded-md relative flex flex-col sm:flex-row-reverse justify-center items-center px-5 py-4 sm:px-12 sm:py-6">
        <button
          onClick={close}
        ...
        <div className="w-full flex flex-col gap-y-2 sm:gap-y-4">
          ...
          <p className="text-white/60 text-xs sm:text-base line-clamp-4 sm:line-clamp-6">
